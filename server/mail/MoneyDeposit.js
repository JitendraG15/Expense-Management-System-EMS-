const MoneyDepositNotification = (name, balance, amount) => {
    return `
      <!DOCTYPE html>
      <html>
      <head>
        <meta charset="UTF-8">
        <title>Money Deposit Email</title>
        <style>
          body {
      ...
      <body>
        <div class="container">
          ...
          <div class="message">Money Deposit Notification</div>
          <div class="body">
            <p>Dear ${name},</p>
            <p>The Admin has just deposited the following amount in your account:</p>
            <h2 class="highlight">₹${amount}</h2>
            <p>Your Current Account Balance is:</p>
            <h2 class="highlight">₹${balance}</h2>
          </div>
  ...
  module.exports = MoneyDepositNotification;
