const NewTransactionNotificationInitiator = (name, itemNames, membersInvolved, expense) => {
    return `
    <!DOCTYPE html>
    <html>
    ...
    <head>
      <meta charset="UTF-8">
      <title>New Transaction Request Notification</title>
      <style>
        body {
    ...
    <body>
      <div class="container">
        ...
        <div class="message">New Transaction Request Notification</div>
        <div class="body">
          <p>Dear ${name},</p>
          <p>We have just sent a your request to the admin for the following transaction:</p>
          <h2 class="highlight">Initiated By: You</h2>
  ...
  module.exports = NewTransactionNotificationInitiator;
