const NewTransactionNotificationMember = (name, memberName,   membersInvolved,itemNames, expense, partOfMember) => {
    return `
    <!DOCTYPE html>
    <html>
    ...
    <body>
      <div class="container">
        ...
        <div class="message">New Expense Notification</div>
        <div class="body">
          <p>Dear ${memberName},</p>
          <p>Mr. ${name} has added the following transaction</p>
          ...
          <p>Your Expense:</p>
          <h2 class="highlight">₹${partOfMember}</h2>
        </div>
  ...
  module.exports = NewTransactionNotificationMember;
