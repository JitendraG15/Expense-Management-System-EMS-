const NewTransactionReplyBack = (name,  itemNames, membersInvolved, expense, partOfMember) => {
    return `
    <!DOCTYPE html>
    <html>
    ...
    <body>
      <div class="container">
        ...
        <div class="body">
          <p>Dear ${name},</p>
          <p>Admin just accepted your following transaction</p>
  ...
  module.exports = NewTransactionReplyBack;
